...
| Возможность | ScoriaDB | BoltDB/bbolt | BadgerDB | LevelDB/GoLevelDB | RocksDB (cgo) | Redis/etcd |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Встраиваемость** | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ |
| **Сетевой доступ** | ✅ | ❌ | ❌ | ❌ | ❌ | ✅ |
| **Web UI** | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ / ✅ |
...
| **Зависимости** | Чистый Go | Чистый Go | Чистый Go | cgo опц. | C++/cgo | Отдельный процесс |
