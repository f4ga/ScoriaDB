...
// Package grpc implements the gRPC server for ScoriaDB, providing
// key-value operations, Column Family management, and authentication
// via the ScoriaDB protocol buffer service definition.
package grpc
