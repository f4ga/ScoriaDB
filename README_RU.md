...
| **Быстродействие** | 7.1M чтений/с, 12.4M WAL операций/с, **1.51M записей/с** |
...
| **v0.3.0** | Производительность ядра | Zero‑copy VLog, sync.Pool, fastrand, graceful shutdown | 🚧 |
...
<br>
v0.3.0 стабильна и протестирована под нагрузкой с zero‑копийным VLog, плавным завершением и тестами восстановления после сбоев. Подходит для production-нагрузок.
</details>
