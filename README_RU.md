...
ScoriaDB распространяется под **Apache License 2.0**.  
Полный текст лицензии находится в файле [LICENSE](LICENSE).  

Дополнительные условия:  
- Проект использует сторонние библиотеки, сведения о которых приведены в [NOTICE](NOTICE).  
- Вклад в проект регулируется [Contributor License Agreement](CONTRIBUTING.md).  
- Все исходные файлы содержат обязательный заголовок лицензии; проверка выполняется автоматически в CI.  

Enterprise-функции (Raft-репликация, Time Travel, mTLS, Row-Level Security, Kubernetes-оператор) будут доступны под отдельной коммерческой лицензией.  
По вопросам коммерческого лицензирования: [ваш email].
